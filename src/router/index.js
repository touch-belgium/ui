...
export default new Router({
  routes: [
    ...
    { path: '/national-championships', name: "national-championships", component: () => import("../views/NationalChampionships.vue") },
    { path: '/competitions/*,:id', name: "competition", component: () => import("../views/Competition.vue")},
