...
export default new Router({
  routes: [
    ...
    { path: '/national-championship', name: "national-championship", component: () => import("../views/NationalChampionships.vue") },
    // { path: '/tournament/*,:id', name: "tournament", component: () => import("../views/Competitions.vue")},
    // { path: '/championship/*,:id', name: "championship", component: () => import("../views/Competitions.vue")},
